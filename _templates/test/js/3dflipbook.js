! function(modules) {
    ...
    _libs.PDFJS.workerSrc = (window.PDFJS_LOCALE ? PDFJS_LOCALE : __webpack_require__.i({
        pdfJsWorker: "http://flipbooklib.loc/wp-content/plugins/flipbooklibrary/templates/test/js/pdf.worker.js",//"js/pdf.worker.js",
        pdfJsCMapUrl: "cmaps/"
    ...
    var Pdf = function() { 
        function Pdf(src, loadingProgress) {console.log( src );
            var _this = this;
    ...
    var _View2 = (__webpack_require__(1), __webpack_require__(65)),
        ...
        BookView = function(_View) {
            ...
            return _inherits(BookView, _View), BookView.prototype.initView = function() {
                ...
                return {
                    html: "http://flipbooklib.loc/wp-content/plugins/flipbooklibrary/templates/test/templates/default-book-view.html",
                    styles: ["http://flipbooklib.loc/wp-content/plugins/flipbooklibrary/templates/test/css/black-book-view.css"],
                    links: [{
                        rel: "stylesheet",
                        href: "http://flipbooklib.loc/wp-content/plugins/flipbooklibrary/templates/test/css/font-awesome.min.css"
                    }],
                    script: "http://flipbooklib.loc/wp-content/plugins/flipbooklibrary/templates/test/js/default-book-view.js"
                }
            }, BookView
        }(_View3.default);
        ...
        View = function() {
            function View(parentContainer, onLoad) {
                ...
                var script = template.html ? template.script : this.getTemplate().script,
                    ...
                    files = {},
                    links = template.links || this.getTemplate().links; console.log( urls );
