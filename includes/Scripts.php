...
//wp_register_script( 'bootstrapmin', './wp-content/pu')
wp_register_style( 'bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css' );
wp_register_style( 'bootstraptheme', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css', ['bootstrap'] );
...
wp_register_script( 'jquery', 'https://code.jquery.com/jquery-3.5.0.min.js' );
wp_register_script( 'bootstrapjs', 'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js' );
